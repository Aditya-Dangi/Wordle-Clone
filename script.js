...
function submitGuess() {
  ...
  stopInteraction();
  const targetLetterCounts = [...targetWord].reduce((counts, letter) => {
    counts[letter] = (counts[letter] || 0) + 1;
    return counts;
  }, {});

  activeTiles.forEach((tile, index) => {
    flipTile(tile, index, activeTiles, guess, targetLetterCounts);
  });
}

function flipTile(tile, index, array, guess, targetLetterCounts) {
  ...
  tile.addEventListener(
    ...
    () => {
      ...
      } else if (targetWord.includes(letter) && targetLetterCounts[letter] > 0) {
